...
const skillsData = [
    ...
    // ==================== 进阶组合（新增分类） ====================
    {
        ...
        difficulty: 'hard',
        mantra: '📝 待编写',
        description: '结合运球、变向、投篮等多项技术的综合进攻手段。',
        steps: [
            { title: '步骤 1', detail: '[待填充]' },
        ],
        commonMistakes: [
        ...
        imageUrl: 'https://placehold.co/800x500/1e293b/f97316?text=Iso+Play+GIF&font=oswald',
        videoEmbed: `<iframe class="w-full aspect-video" src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="待补充视频" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`,
    },

    {
        ...
        imageUrl: 'https://placehold.co/800x500/1e293b/f97316?text=Fast+Break+GIF&font=oswald',
        videoEmbed: `<iframe class="w-full aspect-video" src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="待补充视频" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`,
    },

    {
        ...
        imageUrl: 'https://placehold.co/800x500/1e293b/f97316?text=Three+Pointer+GIF&font=oswald',
        videoEmbed: `<iframe class="w-full aspect-video" src="https://www.youtube.com/embed/dQw4w9WgXcQ" title="待补充视频" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>`,
    },
];
